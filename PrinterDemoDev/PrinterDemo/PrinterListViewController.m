...
//        [selfprint setTitle:NSLocalizedString(@"打印自定义内容", @"") forState:UIControlStateNormal];
//        [selfprint addTarget:self action:@selector(selfprint:) forControlEvents:UIControlEventTouchUpInside];
...
//        
//        height +=44+12;
//        UIButton *taobaobtn = [[UIButton alloc] initWithFrame:CGRectMake(8, 68, 150, 44)];
//        [taobaobtn setTitle:NSLocalizedString(@"查看配套打印机", @"") forState:UIControlStateNormal];
//        [taobaobtn addTarget:self action:@selector(openTaobao:) forControlEvents:UIControlEventTouchUpInside];
//        [taobaobtn setBackgroundColor:[UIColor orangeColor]];
//        [taobaobtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
